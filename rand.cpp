...
int choose_ind ()
{
	...
	area_number = temp->index;

	random_int = rnd(1, area[area_number].area_indcount);
	temp = area[area_number].area_ind->child;
	i = 1;
	while (temp!=NULL&&i<random_int)
	{
		i++;
